...
public enum SystemManageErrorCodeEnum implements BaseErrorEnum {
    ...
    PROP_KEY_TOO_LONG(HttpStatus.BAD_REQUEST, "属性key不能大于128位"),
    PROP_VALUE_NOT_NULL(HttpStatus.BAD_REQUEST, "属性value不能为空"),
    PROP_NOT_REPEAT(HttpStatus.BAD_REQUEST, "属性信息重复"),
    PROP_NOT_EXIST(HttpStatus.BAD_REQUEST, "无属性信息"),
    PROP_NOT_NULL(HttpStatus.BAD_REQUEST, "配置信息不能为空"),
    ...
    PROJECT_NAME_NOT_NULL(HttpStatus.BAD_REQUEST, "项目名称不能为空");
